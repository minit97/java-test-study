...
public class EmployeeController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<Employee> getEmployeeById(@PathVariable("id") long employId) {
        return employeeService.getEmployeeById(employId)
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteEmployee(@PathVariable("id") long employId) {
